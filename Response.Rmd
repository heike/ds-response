...
@marwick:2016 define the "Pi-shaped researcher" as a researcher who in addition to the domain knowledge of the field also knows about and implements best practices of reproducibility. One way to view the divergence between statistics and data science is to say that data science encompasses more computational and literate programming style reproducibility, with a focus on practice as well as theory. 
