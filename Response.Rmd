...
## Historical Parallels
Statistics became an academic discipline separate from mathematics in part due to the focus on problems of a more applied nature that involved real-world data. The first standalone statistics entity was at Iowa State University's Agricultural and Statistical Laboratory, founded by George Snedecor in 1933, and was focused primarily on statistical analyses of agricultural data. A particularly illustrative paragraph from A Lady Tasting Tea [@salsburg2001lady, pp. 216] illustrates the development of statistics as separate from mathematics and lays the foundation for our current situation: 
